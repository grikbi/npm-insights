...
class GetData:
    ...
    def __init__(self, aws_access_key_id=None, aws_secret_access_key=None,
                 aws_bucket_name='cvae-insights', local_data_store=False,
                 deployment_prefix='dev', model_version='2019-01-03'):
    ...
    def load_raw_data(self):
        ...
        NPM_raw_data_path = os.path.join(self.version_name, "data/manifest.json")
        try:
    ...
    def load_existing_data(self):
        ...
        NPM_clean_json_data_path = os.path.join(self.version_name,
