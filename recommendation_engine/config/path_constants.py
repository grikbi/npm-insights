...
PMF_MODEL_PATH = os.path.join(MODEL_VERSION,
...
PRECOMPUTED_STACKS = os.path.join(MODEL_VERSION, 'data/manifest_user_data.dat')
TRAINING_DATA_ITEMS = os.path.join(MODEL_VERSION, 'data/packagedata-train-5-items.dat')
PACKAGE_TAG_MAP = os.path.join(MODEL_VERSION, 'trained-model/package_tag_map.json')
CVAE_MODEL_PATH = os.path.join(MODEL_VERSION, 'intermediate-model/cvae-model/')
